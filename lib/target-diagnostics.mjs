...
// A knob that is a closed set of named modes (Codex's sandbox — unlike
// OpenCode's binary prompt/skip). The set lives on the descriptor
// (`permission.modes`), and `permission.dangerousModes` names the members to
// flag: two for Codex (danger-full-access, bypass — independently dangerous).

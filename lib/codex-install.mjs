...
export function inspectCodexAppServerInstallation({
  ...
  if (installed.complete && definitelyUnquarantined(installed)) {
    ...
    if (installed.quarantined) {
      warnings.push(`Configured Codex at ${installed.realPath} carries com.apple.quarantine (${installed.quarantine}); no usable same-version unquarantined extracted pair was found.`);

...
//
// Health is target-aware: the bridge is "bring your target", so a doctor run
// is OK when the common prerequisites pass AND the configured target (or, if
// none is configured, at least one selectable target) is ready. Copilot is

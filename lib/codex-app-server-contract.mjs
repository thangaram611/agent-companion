...
//
// Measured on codex-cli 0.150.1: 79 server notifications (58 flat `threadId`,
...
// `params.conversationId`), 95 client requests. Three of the 58 declare their
...
// additive — every new notification carries `params.threadId` or is global.)
//
...
// of all 79 notifications and the fields of all 18 `ThreadItem` variants —
